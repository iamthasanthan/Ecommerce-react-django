    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('manager', 'Manager'), ('seller', 'Seller'), ('buyer', 'Buyer'), ('viewer', 'Viewer')], default='viewer', max_length=120)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_cover_photo', models.ImageField(upload_to='seller/business_cover_photo/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_user_name', models.CharField(blank=True, max_length=120, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
